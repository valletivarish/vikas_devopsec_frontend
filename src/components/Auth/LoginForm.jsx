    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-gray-900 to-cyan-950 flex items-center justify-center px-4 py-12">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-cyan-300 mt-1">Sign in to your account</p>
        </div>
        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-2xl border border-white/20 p-8 shadow-2xl">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-cyan-600 to-sky-600 hover:from-cyan-500 hover:to-sky-500 text-white font-medium py-2.5 rounded-xl flex items-center justify-center gap-2 transition-all disabled:opacity-50 shadow-lg shadow-cyan-500/25"
            >
          ...
          <div className="mt-6 pt-5 border-t border-white/10">
            <p className="text-xs text-cyan-300/70 text-center mb-3 uppercase tracking-wider">Demo Accounts</p>
            <div className="grid grid-cols-3 gap-2">
              <button
                type="button"
                disabled={loading}
                onClick={() => fillCredentials('demouser', 'Demo@1234')}
                className="flex flex-col items-center gap-1 py-2.5 px-2 rounded-xl bg-white/5 border border-white/10 hover:bg-white/15 hover:border-cyan-400/40 transition-all disabled:opacity-50"
              >
                <FiUser className="w-4 h-4 text-emerald-400" />
                <span className="text-xs text-cyan-200">Demo User</span>
              </button>
              <button
                type="button"
                disabled={loading}
              ...
              >
                ...
                <span className="text-xs text-cyan-200">Admin</span>
              </button>
              <button
                type="button"
                disabled={loading}
              ...
              >
                ...
                <span className="text-xs text-cyan-200">Analyst</span>
              </button>
            </div>
          </div>
        </div>
        ...
        <p className="text-center text-sm text-cyan-300/70 mt-6">
          ...
          <Link to="/register" className="text-cyan-300 hover:text-white font-medium transition-colors">
            Create an account
          </Link>
        </p>
      </div>
